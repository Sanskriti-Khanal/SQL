...
heading2.place(x=750, y=70)


leftFrame=Frame(root,bg='#DFA7E4')
leftFrame.place(x=5,y=155,width=360,height=525)

updatedatabutton=Button(leftFrame,text='Update Data',font=('Open Sans', 16, 'bold'), fg='#A5256B', bg='#DFA7E4', activebackground='#DFA7E4', highlightbackground='#DFA7E4', cursor='hand2', bd=0,width=13)
updatedatabutton.grid(row=2,column=0,pady=20,padx=100)
