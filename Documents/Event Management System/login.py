...
usernameEntry = Entry(root, width=40, font=('Microsoft Yahei UI Light', 11), bg='white', bd=0, fg='#A5256B',
...
passwordEntry = Entry(root, width=40, font=('Microsoft Yahei UI Light', 11), bg='white', bd=0, fg='#A5256B',
                      highlightbackground='white')
...
forgetButton = Button(root, text='Forgot Password?', bd=0, bg='#DFA7EA', activebackground='#DFA7E4', cursor='hand2',
                      highlightbackground='#DFA7E4', font=('Microsoft Yahei UI Light', 9), fg='#A5256B')
forgetButton.place(x=825, y=350)

LoginButton = Button(root, text='Login', font=('Open Sans', 16, 'bold'), fg='#A5256B', bg='#A5256B',
...
NewButton = Button(root, text='Create', font=('Open Sans', 9, 'bold'), fg='#A5256B', bg='#A5256B',
                   activebackground='#DFA7E4', highlightbackground='#DFA7E4', cursor='hand2', bd=0)
